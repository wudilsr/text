...
extern int f2fs_test_bit(u64, const char *);
extern int f2fs_set_bit(u64, char *);
extern int f2fs_clear_bit(u64, char *);
...
extern int cmp_kernel_version(__u8 *, __u8 *);
f2fs_hash_t f2fs_dentry_hash(const unsigned char *, unsigned int);
