...
static const StreamType DESC_types[] = {
    ...
    { 0x15, AVMEDIA_TYPE_AUDIO,    AV_CODEC_ID_AC4          }, /* AC-4 descriptor */
    { 0 },
};
                              ...
                              MpegTSContext *ts)
{
    ...
    case 0x7f: /* DVB extension descriptor */
        ...
        if (stream_type == STREAM_TYPE_PRIVATE_DATA && ext_desc_tag == 0x15) {
            mpegts_find_stream_type(st, ext_desc_tag, DESC_types);
            av_log(fc, AV_LOG_VERBOSE, "DOLBY AC4\n");
        }
        break;
    default:
        break;
