...
# open CONFIG_HUAWEI_DATA_ACQUISITION only factory version
ifeq ($(CONFIG_FACTORY_ANDROID),true)
KERNEL_CONFIG_OVERRIDE += CONFIG_HUAWEI_DATA_ACQUISITION=y
endif
...
KERNEL_CONFIG_OVERRIDE += CONFIG_MMC_RING_BUFFER=n
KERNEL_CONFIG_OVERRIDE += CONFIG_EXT4_ENCRYPTION=n
KERNEL_CONFIG_OVERRIDE += CONFIG_EXT4_FS_ENCRYPTION=n
KERNEL_CONFIG_OVERRIDE += CONFIG_EXT4_FS_ICE_ENCRYPTION=n
...
ifeq ($(KP_BUILD), true)
	...
	vendor/opensource/patch_tool/kernel_patch_build ${KP_PARA} -v ${KP_VMLINUX} -c ${KP_CONFIG} -r ${KP_UTSRELEASE_H} -n ${KP_PATCH_NAME} -d ${KP_PATCH}
