...
#ifdef CONFIG_HUAWEI_WIFI
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
                 "%s: Management subtype:%d SA:"HW_MAC_ADDRESS_STR" DA:"
                 HW_MAC_ADDRESS_STR, __func__, pRxMetadata->subtype,
                 HW_MAC_ADDR_ARRAY(pHdr->sa), HW_MAC_ADDR_ARRAY(pHdr->da));
#else
        VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
...
#ifdef CONFIG_HUAWEI_WIFI
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
                  "%s: Control subtype:%d SA:"HW_MAC_ADDRESS_STR" DA:"
                  HW_MAC_ADDRESS_STR, __func__, pRxMetadata->subtype,
                  HW_MAC_ADDR_ARRAY(pHdr->sa), HW_MAC_ADDR_ARRAY(pHdr->da));
#else
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
...
#ifdef CONFIG_HUAWEI_WIFI
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
                  "%s: Data subtype:%d SA:"HW_MAC_ADDRESS_STR" DA:"
                  HW_MAC_ADDRESS_STR, __func__, pRxMetadata->subtype,
                  HW_MAC_ADDR_ARRAY(pHdr->sa), HW_MAC_ADDR_ARRAY(pHdr->da));
#else
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
...
#ifdef CONFIG_HUAWEI_WIFI
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
                  "%s: Unknown frame SA:"HW_MAC_ADDRESS_STR,
                   __func__, HW_MAC_ADDR_ARRAY(pHdr->sa));
#else
       VOS_TRACE(VOS_MODULE_ID_WDI, VOS_TRACE_LEVEL_ERROR,
