                               ...
                               uint8_t event_type)
{
    ...
    {
#ifdef CONFIG_HUAWEI_WIFI
        hddLog(LOGE, FL("%s: M1 packet"),eapol_params.event_sub_type ==
    ...
    {
#ifdef CONFIG_HUAWEI_WIFI
        hddLog(LOGE, FL("%s: M2 packet"),eapol_params.event_sub_type ==
               WIFI_EVENT_DRIVER_EAPOL_FRAME_RECEIVED ? "RX" : "TX");
#else
    ...
    {
#ifdef CONFIG_HUAWEI_WIFI
        hddLog(LOGE, FL("%s: M3 packet"),eapol_params.event_sub_type ==
               WIFI_EVENT_DRIVER_EAPOL_FRAME_RECEIVED ? "RX" : "TX");
#else
    ...
    {
#ifdef CONFIG_HUAWEI_WIFI
        hddLog(LOGE, FL("%s: M4 packet"),eapol_params.event_sub_type ==
               WIFI_EVENT_DRIVER_EAPOL_FRAME_RECEIVED ? "RX" : "TX");
#else
