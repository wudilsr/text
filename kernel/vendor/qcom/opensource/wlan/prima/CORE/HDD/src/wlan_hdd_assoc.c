...
static void hdd_SendAssociationEvent(struct net_device *dev,tCsrRoamInfo *pCsrRoamInfo)
{
    ...
    hddLog(VOS_TRACE_LEVEL_ERROR, HW_MAC_ADDRESS_STR " connected to "
           HW_MAC_ADDRESS_STR,
                                                    ...
                                                    eCsrRoamResult roamResult )
{
    ...
    else
    {
...
#ifdef CONFIG_HUAWEI_WIFI
       VOS_TRACE( VOS_MODULE_ID_HDD, VOS_TRACE_LEVEL_ERROR,
                    "wlan: connection failed with " HW_MAC_ADDRESS_STR " result:%d and Status:%d",
                    HW_MAC_ADDR_ARRAY(pRoamInfo->bssid), roamResult, roamStatus);
#else
       VOS_TRACE( VOS_MODULE_ID_HDD, VOS_TRACE_LEVEL_ERROR,
       ...
       VOS_TRACE( VOS_MODULE_ID_HDD, VOS_TRACE_LEVEL_ERROR,
                   "wlan: connection failed with " HW_MAC_ADDRESS_STR " result:%d and Status:%d",
                    HW_MAC_ADDR_ARRAY(pWextState->req_bssId),
                    roamResult, roamStatus);
#else
       VOS_TRACE( VOS_MODULE_ID_HDD, VOS_TRACE_LEVEL_ERROR,
                   "wlan: connection failed with " MAC_ADDRESS_STR " result:%d and Status:%d",
       ...
       hddLog(VOS_TRACE_LEVEL_ERROR,
                     ...
                     " for bssid " HW_MAC_ADDRESS_STR
                     " result:%d and Status:%d reasonCode %d" ,
                     __func__, HW_MAC_ADDR_ARRAY(pRoamInfo->bssid),
       ...
       hddLog(VOS_TRACE_LEVEL_ERROR,
                     ...
                     " for bssid " HW_MAC_ADDRESS_STR
                     " result:%d and Status:%d" ,
                     __func__, HW_MAC_ADDR_ARRAY(pWextState->req_bssId),
                     roamResult, roamStatus);
#else
       hddLog(VOS_TRACE_LEVEL_ERROR,
                     "%s: connect failed:"
