...
struct dsm_sdcard_cmd_log dsm_sdcard_cmd_logs[] =
{
	...
	{"CMD6_CMDERR : ",      0,		0},
	{"CMD6_DATERR : ",      0,		0},
	{"BLK_STUCK_IN_PRG_ERR : ", 	0,	0},	/* 15 */
	{"BLK_WR_SPEED_ERR : ",		0,	0},
	{"BLK_RW_CHECK_ERR : ",		0,	0},
	{"CSD_REG_RO_ERR : ",		0,	0},
	{"FILESYSTEM_ERR : ",		0,	0},
	{"LOWSPEED_SPEC_ERR : ",	0,	0},	/*reality this not report dot in code*/
	{"Report Uevent : ",		0,	0},
	{"Hardware Timeout err : ",	0,	0},	/*reality this not get dot to copty in code, via DSM_SDCARD_LOG in Qcom*/
	{"MMC_BLK_ABORT : ",		0,	0},	/*reality this not get dot to copty in code, via DSM_SDCARD_LOG in Qcom*/
        {/*sentinel*/}
};
