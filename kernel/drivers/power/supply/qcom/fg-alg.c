 ...
 *
 */
int get_bucket_cycle_count(struct cycle_counter *counter)
{
	int count;
 ...
 * Get average cycle count for all buckets
 */
int get_chg_cycle_count(struct cycle_counter *counter, int *count)
{
       int i, rc, temp = 0, temp_count = 0;
