...
#define CURR_UA_TO_MA           1000
#define INVALID_VALUE           INT_MIN
#define SOC_JUMP_STEP           3
#define SOC_JUMP_LOW_TEMP       -50
...
enum DSM_CHARGER_ERR {
    ...
    DSM_STILL_CHARGE_WHEN_OVER_VOLT,
    DSM_HEATH_OVERHEAT,
...
#define DSM_PMU_LOG(client, err_num, fmt, ...) \
    do { \
