/* 
 * This file just use for Codec dump for Kernel Version >= 4.4, 
 * and only used by hw_audio_info.c
*/

#ifndef _HW_CODEC_REGISTER_TABLE_H
#define _HW_CODEC_REGISTER_TABLE_H

#define MSM89XX_PMIC_BASE	0xF000
...
const u8 msm89xx_pmic_cdc_reg_readable[MSM89XX_PMIC_CDC_CACHE_SIZE] = {
		...
		[MSM89XX_PMIC_DIGITAL_DIG_DEBUG_EN] = 1,
		...
		[MSM89XX_PMIC_DIGITAL_PERPH_RESET_CTL1] = 1,
		[MSM89XX_PMIC_DIGITAL_PERPH_RESET_CTL2] = 1,
		[MSM89XX_PMIC_DIGITAL_PERPH_RESET_CTL3] = 1,
		[MSM89XX_PMIC_DIGITAL_PERPH_RESET_CTL4] = 1,
		[MSM89XX_PMIC_DIGITAL_INT_TEST1] = 1,
		[MSM89XX_PMIC_DIGITAL_INT_TEST_VAL] = 1,
		[MSM89XX_PMIC_DIGITAL_TRIM_NUM] = 1,
		[MSM89XX_PMIC_DIGITAL_TRIM_CTRL] = 1,
		...
		[MSM89XX_PMIC_ANALOG_RX_LO_DAC_CTL] = 1,
		[MSM89XX_PMIC_ANALOG_RX_LO_EN_CTL] = 1,
		...
		[MSM89XX_PMIC_ANALOG_PERPH_RESET_CTL1] = 1,
		[MSM89XX_PMIC_ANALOG_PERPH_RESET_CTL2] = 1,
		[MSM89XX_PMIC_ANALOG_PERPH_RESET_CTL3] = 1,
		[MSM89XX_PMIC_ANALOG_PERPH_RESET_CTL4] = 1,
		[MSM89XX_PMIC_ANALOG_INT_TEST1] = 1,
		[MSM89XX_PMIC_ANALOG_INT_TEST_VAL] = 1,
		[MSM89XX_PMIC_ANALOG_TRIM_NUM] = 1,
		[MSM89XX_PMIC_ANALOG_TRIM_CTRL1] = 1,
		[MSM89XX_PMIC_ANALOG_TRIM_CTRL2] = 1,
		[MSM89XX_PMIC_ANALOG_TRIM_CTRL3] = 1,
		[MSM89XX_PMIC_ANALOG_TRIM_CTRL4] = 1,
};

#define MSM89XX_CDC_CORE_REG_BASE  (0x00)
...
bool msm89xx_analog_codec_readable_reg(unsigned int reg)
{
	return msm89xx_pmic_cdc_reg_readable[reg];
}
bool msm89xx_digital_codec_readable_reg(unsigned int reg)
{
